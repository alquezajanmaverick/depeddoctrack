<?php 
	...
	if(isset($_GET['itemno'])){
		...
		$db->query("CALL getsingleposition(?)");
...
<body ng-app="assignApp" ng-controller="assignCtrl">
    	...
    	<div class="col-md-8 col-md-offset-2">
        	...
        	<div class="panel panel-warning">
                ...
                <div class="panel-body">
                   ...
                   <form method="post" action="add-process.php" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                               <input type="text" value="<?php echo $x['positioncategory']; ?>" name="category" class="form-control" id="category" placeholder="Position" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="duedate" ng-model="duedate" class="form-control" id="duedate" placeholder="Due-date of Submission"  uib-datepicker-popup="yyyy-MM-dd" datepicker-options="datepicker" is-open="popup4.opened" required>
                                <span class="input-group-btn">
